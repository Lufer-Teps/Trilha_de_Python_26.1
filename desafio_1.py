...
orcamento= float (input("Boas vindas a calcuadora de gastos, por favor digite o seu orçamento em reais."))
...
if orcamento < 0 or passagem < 0 or diaria < 0 or tempo < 0:
    print("valor invalido, voce digitou uma variavel negativa.")
else:
...
#variaveis essenciais.
    ...
    if custo_total >= orcamento:
        ...
        print(f"informações finais: o seu orçamento é de {orcamento} reais. Sua viagem para {destino} durará {tempo}. O custo da sua hospedagem será de {valor_da_hospedagem} o custo total da viagem sera de {custo_total} e ainda sobrará {dinheiro_restante}. ")
